...
## Note that this script depends on the CHIS dataset. They are available at
## http://healthpolicy.ucla.edu. They were already loaded in the workspace in the datacamp.
#library(foreign)
#file <- "ADULT.dta"
#CHIS   <- read.dta(file, convert.factors = TRUE)
#adult is a subset of ADULT dataset

adult <- read.csv("chis.adult.sample.csv")
